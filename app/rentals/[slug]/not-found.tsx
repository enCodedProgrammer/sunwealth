    ...
    <Container className="py-20 lg:py-32">
      <div className="flex max-w-xl flex-col gap-4">
        ...
        <h1 className="font-display text-4xl leading-tight text-ink md:text-5xl">
          We couldn&rsquo;t find that rental.
        </h1>
        <p className="text-stone">
          It may have been let or unpublished. Browse our current rentals or
          ask our concierge to help you find something similar.
        </p>
        <div className="mt-2">
          <Link
            href="/rentals"
